...
# home.alunduil.com is intentionally absent: the ddns-updater app on TrueNAS
# owns its A record, and a Terraform-managed copy would fight it on every
# plan. See docs/how-to/configure-truenas-ddns-updater.md.
